<h1 align="center">CoCart - Admin Package</h1>

<p align="center"><img src="https://cocart.xyz/wp-content/uploads/2021/11/cocart-home-default.png.webp" alt="CoCart Logo" /></p>

<br>

This is a package for CoCart that provides the WordPress dashboard components to help users setup, notify and update CoCart as well as provide plugin suggestions and system status information.

It is designed to be pulled in via Composer when CoCart is compiled for a plugin build release.

Any administrator features are controlled and maintained in this package.
...
CoCart Admin Package is developed and maintained by [Sébastien Dumont](https://github.com/seb86).
