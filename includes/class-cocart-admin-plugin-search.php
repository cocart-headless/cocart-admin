...
class PluginSearch {
	...
	public function load_plugins_search_script() {
		...
		wp_enqueue_script( COCART_SLUG . '-plugin-search', COCART_ADMIN_URL_PATH . '/assets/js/admin/plugin-search' . $suffix . '.js', array( 'jquery' ), COCART_VERSION, true );
		wp_localize_script(
		...
		wp_register_style( COCART_SLUG . '-plugin-search', COCART_ADMIN_URL_PATH . '/assets/css/admin/plugin-search' . $suffix . '.css', array(), COCART_VERSION );
	...
	public function get_addons_list() {
		...
		return array(
			'cocart-acf'       => array(
				...
				'logo'              => COCART_ADMIN_URL_PATH . '/assets/images/plugin-suggestions/cocart.png',
				'requirement'       => false,
				'requires'          => '5.2',
				'tested'            => '5.6',
				'requires_php'      => '7.2',
	...
	public function get_third_party_list() {
		return array(
			'woocommerce-name-your-price'             => array(
				...
				'logo'              => COCART_ADMIN_URL_PATH . '/assets/images/plugin-suggestions/kia-logo.png',
				'requirement'       => false,
				'requires'          => '4.4',
				'tested'            => '5.3',
				'requires_php'      => '7.0',
			...
			'woocommerce-subscriptions'               => array(
				...
				'logo'              => COCART_ADMIN_URL_PATH . '/assets/images/plugin-suggestions/woocommerce.png',
				'requirement'       => sprintf(
					/* translators: %s: CoCart */
