...
<div class="container">
	<div class="content">
		...
		<video controls playsinline disablepictureinpicture poster="<?php echo esc_url( COCART_ADMIN_URL_PATH . '/assets/images/testimonials/james-rowland.png' ); ?>" style="width: 100%; height: 100%; max-height: 65vh;" preload="auto">
